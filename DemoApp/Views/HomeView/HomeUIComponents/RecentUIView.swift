...
class CustomRecentCollectionCell : UICollectionViewCell {
...
class RecentUIView : UIView {
    ...
    override init(frame: CGRect) {
        ...
        recentCollectionView.register(CustomRecentCollectionCell.self, forCellWithReuseIdentifier: CustomRecentCollectionCell.identifier)
        
        NSLayoutConstraint.activate([
            recentCollectionView.topAnchor.constraint(equalTo: topAnchor),
            recentCollectionView.leadingAnchor.constraint(equalTo: leadingAnchor),
            recentCollectionView.trailingAnchor.constraint(equalTo: trailingAnchor),
            recentCollectionView.bottomAnchor.constraint(equalTo: bottomAnchor),
        ])
    }
...
extension RecentUIView : UICollectionViewDelegate , UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CustomRecentCollectionCell.identifier, for: indexPath) as? CustomRecentCollectionCell else {
